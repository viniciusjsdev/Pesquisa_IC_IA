...
| O que | Motivo |
|---|---|
| `finetune_mistral_wsl/venv/` | Reinstala na nuvem com `pip install` |
| `finetune_mistral_wsl/output/` | Artefatos do modelo legado, não necessários |
...
legacy:
  adapter_dir: "/workspace/FineTuning/finetune_mistral_wsl/output/legacy"
  checkpoints_dir: "/workspace/FineTuning/finetune_mistral_wsl/output/checkpoints"
```
...
```
FineTuning/
├── finetune_mistral_wsl/   (sem venv/ e sem output/)
├── configs/
├── data/processed/
├── data/manifests/
└── docs/
...
cd /workspace/FineTuning/finetune_mistral_wsl
