...
class CasasBahiaStrategy(RaspagemStrategy):
    """Estratégia específica para raspagem do RI da Casas Bahia."""

    def __init__(self):
        self._empresa = "CasasBahia"
    ...
    def baixar_relatorios(self) -> List[RelatorioFinanceiro]:
        ...
        with sync_playwright() as p:
            ...
            anos_filtrados = [str(ano) for ano in range(ano_atual - 4, ano_atual + 1)]
