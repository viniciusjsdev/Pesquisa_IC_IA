...
class GPAStrategy(RaspagemStrategy):
    """Estratégia específica para raspagem do RI do Grupo Pão de Açúcar."""
    ...
    def baixar_relatorios(self) -> List[RelatorioFinanceiro]:
        ...
        with sync_playwright() as p:
            ...
            anos_filtrados = [str(ano) for ano in range(ano_atual - 5, ano_atual + 1) if str(ano)]
