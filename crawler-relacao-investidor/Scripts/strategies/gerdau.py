...
import empresas_ri.config  

class GerdauStrategy(RaspagemStrategy):
    """Estratégia específica para raspagem do RI da Gerdau"""

    def __init__(self):
        self._empresa = "Gerdau"
    ...
    def baixar_relatorios(self) -> List[RelatorioFinanceiro]:
        ...
        with sync_playwright() as p:
            ...
            anos_filtrados = [str(ano) for ano in range(ano_atual - 10, ano_atual + 1) if str(ano)]
