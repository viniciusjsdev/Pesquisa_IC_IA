...
4. Treinamento parametrizado (`finetune_mistral_wsl/2_treinar_wsl.py`)
5. Avaliação em lote (`finetune_mistral_wsl/5_avaliar_batch_wsl.py`)
6. Demo qualitativo (`finetune_mistral_wsl/3_testar_wsl.py`) e inferência (`4_inferencia_wsl.py`)
...
- `finetune_mistral_wsl/common/`: utilitários reutilizáveis
