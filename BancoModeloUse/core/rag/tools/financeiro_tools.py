# core/rag/tools/financeiro_tools.py
"""
...
class FinanceiroTools:
    """Ferramentas para consultas financeiras"""
    ...
    def query_financeira(self, consulta: str, parametros: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        Args:
            consulta: Tipo de consulta ('vendas', 'custos', 'lancamentos', 'orcamentos')
            parametros: Parâmetros da consulta (data_inicio, data_fim, produto_id, etc.)
        ...
        with get_financeiro_db() as db:
            ...
            if consulta == 'vendas':
                return self._consultar_vendas(data_inicio, data_fim, parametros)
            elif consulta == 'custos':
                return self._consultar_custos(data_inicio, data_fim, parametros)
            elif consulta == 'lancamentos':
                return self._consultar_lancamentos(data_inicio, data_fim, parametros)
            elif consulta == 'orcamentos':
                return self._consultar_orcamentos(data_inicio, data_fim, parametros)
            else:
